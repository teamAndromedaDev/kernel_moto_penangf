...
static int hl7139_adc_iin_disable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL1, HL7139_IIN_ADC_DIS_MASK,
				val);
...
static int hl7139_adc_vbat_disable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL1, HL7139_VBAT_ADC_DIS_MASK,
				val);
...
static int hl7139_adc_ibat_disable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL1, HL7139_IBAT_ADC_DIS_MASK,
				val);
...
static int hl7139_adc_ts_disable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL1, HL7139_TS_ADC_DIS_MASK,
				val);
...
static int hl7139_adc_tdie_disable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL1, HL7139_TDIE_ADC_DIS_MASK,
				val);
...
static int hl7139_adc_vout_disable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL1, HL7139_VOUT_ADC_DIS_MASK,
				val);
...
static int hl7139_get_adc_data(struct hl7139_charger *chg, int channel,
			       int *result)
{
	int ret;
	u8 r_val_high;
	...
	ret = hl7139_read_reg(chg, AL7139_GET_ADC_BASE_REG + (channel << 1),
			      &r_val_low);
	ret = hl7139_read_reg(chg, AL7139_GET_ADC_BASE_REG + (channel << 1) + 1,
			      &r_val_high);
...
static int hl7139_track_ov_disable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_TRACK_OV_UV,
...
static int hl7139_track_ov(struct hl7139_charger *chg, int mv)
{
	...
	ret = hl7139_update_reg(chg, HL7139_TRACK_OV_UV, HL7139_TRACK_OV_MASK,
				val);
...
static int hl7139_track_uv(struct hl7139_charger *chg, int mv)
{
	...
	ret = hl7139_update_reg(chg, HL7139_TRACK_OV_UV, HL7139_TRACK_UV_MASK,
				val);
...
static int hl7139_ucp_deb_select(struct hl7139_charger *chg, u8 mode)
{
	...
	ret = hl7139_update_reg(chg, HL7139_CTRL1, HL7139_UCP_DEB_SEL_MASK,
				val);
...
static int hl7139_auto_v_rec_enable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_CTRL1, HL7139_AUTO_V_REC_EN_MASK,
				val);
...
static int hl7139_auto_i_rec_enable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_CTRL1, HL7139_AUTO_I_REC_EN_MASK,
				val);
...
static int hl7139_auto_ucp_rec_enable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_CTRL1, HL7139_AUTO_UCP_REC_EN_MASK,
				val);
...
static int hl7139_set_vin_pd_cfg(struct hl7139_charger *chg, bool mode)
{
	...
	ret = hl7139_update_reg(chg, HL7139_VIN_OVP_REG, HL7139_PD_CFG_MASK,
				val);
	return ret;
}
...
static int hl7139_set_vbus_pd_en(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_VBUS_OVP_REG,
				HL7139_VBUS_PD_EN_MASK, val);
	return ret;
}
static int hl7139_set_batovp_deb(struct hl7139_charger *chg, int deb)
{
	...
	ret = hl7139_update_reg(chg, HL7139_VBAT_REG, HL7139_BAT_OVP_DEB_MASK,
				val);
	return ret;
}
...
static int hl7139_set_batocp_deb(struct hl7139_charger *chg, int deb)
{
	...
	ret = hl7139_update_reg(chg, HL7139_IBAT_REG, HL7139_BAT_OCP_DEB_MASK,
				val);
	return ret;
}
...
static int hl7139_set_vgs_sel(struct hl7139_charger *chg, int vol)
{
	...
	ret = hl7139_update_reg(chg, HL7139_VBUS_OVP_REG, HL7139_VGS_SEL_MASK,
				val);
	return ret;
}
static int hl7139_set_tiin_oc_deb(struct hl7139_charger *chg, int tdeb)
{
	...
	ret = hl7139_update_reg(chg, HL7139_IIN_OC_REG, HL7139_IIN_OC_DEB_MASK,
				val);
	return ret;
}
static int hl7139_set_iin_ocp_th(struct hl7139_charger *chg, int threshold)
{
	...
	ret = hl7139_update_reg(chg, HL7139_IIN_OC_REG, HL7139_IIN_OCP_TH_MASK,
				val);
	return ret;
}
static int hl7139_set_tdie_reg_dis(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_REG_CTRL0, HL7139_TDIE_REG_DIS_MASK,
				val);
	return ret;
}
...
static int hl7139_set_tdie_reg_th(struct hl7139_charger *chg, int threshold)
{
	...
	ret = hl7139_update_reg(chg, HL7139_REG_CTRL0, HL7139_TDIE_REG_TH_MASK,
				val);
	return ret;
}
...
static int hl7139_adc_man_copy(struct hl7139_charger *chg, bool mode)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL0, HL7139_ADC_REG_COPY_MASK,
				val);
...
static int hl7139_adc_reg_copy(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL0, HL7139_ADC_MAN_COPY_MASK,
				val);
...
static int hl7139_adc_mode_config(struct hl7139_charger *chg, int mode)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL0, HL7139_ADC_MODE_CFG_MASK,
				val);
...
static int hl7139_adc_avg_time(struct hl7139_charger *chg, int mode)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL0, HL7139_ADC_AVG_TIME_MASK,
				val);
...
static int hl7139_adc_vin_disable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL1, HL7139_VIN_ADC_DIS_MASK,
				val);
...
static int hl7139_bulk_read_reg(struct hl7139_charger *chg, int reg, void *val,
				int count)
{
	int ret = 0;
...
static int hl7139_update_reg(struct hl7139_charger *chg, int reg, u8 mask,
			     u8 val)
{
	int ret = 0;
	unsigned int temp;
...
static int hl7139_parse_dt(struct device *dev,
			   struct hl7139_platform_data *pdata)
{
	...
	pdata->bat_ovp_disable =
		of_property_read_bool(np, "hl,hl7139,bat-ovp-disable");
	pdata->bat_ocp_disable =
		of_property_read_bool(np, "hl,hl7139,bat-ocp-disable");
	pdata->vin_ovp_disable =
		of_property_read_bool(np, "hl,hl7139,vin-ovp-disable");
	pdata->iin_ocp_disable =
		of_property_read_bool(np, "hl,hl7139,iin-ocp-disable");
	pdata->vout_ovp_disable =
		of_property_read_bool(np, "hl,hl7139,vout-ovp-disable");
	...
	if (rc) {
		pr_info("%s: failed to get switching frequency from dtsi",
			__func__);
	...
	rc = of_property_read_u32(np, "hl7139,input-current-limit",
				  &pdata->iin_cfg);
	if (rc) {
		pr_info("%s: failed to get input-current-limit from dtsi",
			__func__);
		pdata->iin_cfg = HL7139_CP_IIN_CFG_DFT;
	}

	rc = of_property_read_u32(np, "hl7139,topoff-current",
				  &pdata->iin_topoff);
	if (rc) {
...
static int hl7139_check_charge_enabled(struct hl7139_charger *chg,
				       bool *enabled)
{
	int ret;
	u8 val;
...
static int hl7139_set_batovp_th(struct hl7139_charger *chg, int threshold)
{
	...
	ret = hl7139_update_reg(chg, HL7139_VBAT_REG, HL7139_BAT_OVP_SET_MASK,
				val);
	return ret;
}
...
static int hl7139_set_batocp_th(struct hl7139_charger *chg, int threshold)
{
	...
	ret = hl7139_update_reg(chg, HL7139_IBAT_REG, HL7139_BAT_OCP_ALM_MASK,
				val);
	return ret;
}
...
static int hl7139_set_vin_ovp_dis(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_VIN_OVP_REG, HL7139_OVP_DIS_MASK,
				enable);
	return ret;
}
...
static int hl7139_set_vin_ovp_th(struct hl7139_charger *chg, int threshold)
{
	...
	if (bpcp == HL7139_DEV_MODE_BP_MODE) {
		if (threshold <= 5100)
			...
			return -EINVAL;
		val = (threshold - HL7139_OVP_VAL_BP_MIN) /
		      HL7139_OVP_VAL_BP_LSB;
	} else {
		if (threshold <= 10200)
			...
			return -EINVAL;
		val = (threshold - HL7139_OVP_VAL_CP_MIN) /
		      HL7139_OVP_VAL_CP_LSB;
	}

	pr_info("%s: val 0x%x threshold %d\n", __func__, val, threshold);
	val <<= HL7139_OVP_VAL_SHIFT;

	ret = hl7139_update_reg(chg, HL7139_VIN_OVP_REG, HL7139_OVP_VAL_MASK,
				val);
	return ret;
}
...
static int hl7139_set_iin_ocp_dis(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_IIN_REG, HL7139_IIN_OCP_DIS_MASK,
				val);
	return ret;
}
...
static int hl7139_set_iin_reg_th(struct hl7139_charger *chg, int threshold)
{
	...
	if (bpcp == HL7139_DEV_MODE_BP_MODE) {
		if (threshold <= 1000)
			...
			return -EINVAL;
		val = (threshold - HL7139_IIN_REG_TH_BP_MIN) /
		      HL7139_IIN_REG_TH_BP_LSB;
	} else {
		if (threshold <= 2000)
			...
			return -EINVAL;
		val = (threshold - HL7139_IIN_REG_TH_CP_MIN) /
		      HL7139_IIN_REG_TH_CP_LSB;
	}

	pr_info("%s: val 0x%x threshold %d\n", __func__, val, threshold);
	val <<= HL7139_IIN_REG_TH_SHIFT;

	ret = hl7139_update_reg(chg, HL7139_IIN_REG, HL7139_IIN_REG_TH_MASK,
				val);
	return ret;
}
...
static int hl7139_set_iin_reg_dis(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_REG_CTRL0, HL7139_IIN_REG_DIS_MASK,
				val);
	return ret;
}
...
static int hl7139_set_vbat_reg_dis(struct hl7139_charger *chg, bool enable)
{
	...
	pr_err("%s:reg val = %d\n", __func__, val);
	ret = hl7139_update_reg(chg, HL7139_REG_CTRL1, HL7139_VBAT_REG_DIS_MASK,
				val);
	hl7139_read_reg(chg, HL7139_REG_CTRL1, &val);
	pr_err("%s:reg val = %d\n", __func__, val);
	return ret;
...
static int hl7139_set_ibat_reg_dis(struct hl7139_charger *chg, bool enable)
{
	...
	hl7139_read_reg(chg, HL7139_REG_CTRL1, &val);
	pr_err("%s:reg val = %d\n", __func__, val);
	ret = hl7139_update_reg(chg, HL7139_REG_CTRL1, HL7139_IBAT_REG_DIS_MASK,
				val);
	hl7139_read_reg(chg, HL7139_REG_CTRL1, &val);
	pr_err("%s:reg val = %d\n", __func__, val);
	return ret;
...
static int hl7139_set_vbat_ovp_th(struct hl7139_charger *chg, int threshold)
{
	...
	ret = hl7139_update_reg(chg, HL7139_REG_CTRL1, HL7139_VBAT_OVP_TH_MASK,
				val);
	return ret;
}
...
static int hl7139_set_ibat_ovp_th(struct hl7139_charger *chg, int threshold)
{
	...
	ret = hl7139_update_reg(chg, HL7139_REG_CTRL1, HL7139_IBAT_OCP_TH_MASK,
				val);
	return ret;
}
...
static int hl7139_check_vbus_error_status(struct hl7139_charger *chg,
					  int *result)
{
	int ret;
	u8 reg;
...
static int hl7139_device_init(struct hl7139_charger *chg)
{
	...
	/* REG0x14, WDT setting */
	value = chg->pdata->wd_dis ? (0x8 | chg->pdata->wd_tmr) :
				     (0x00 | chg->pdata->wd_tmr);
...
static int hl7139_adc_read_enable(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_ADC_CTRL0, HL7139_ADC_READ_EN_MASK,
				val);
	return ret;
}
...
static int hl7139_vout_ovp_dis(struct hl7139_charger *chg, bool enable)
{
	...
	ret = hl7139_update_reg(chg, HL7139_CTRL1, HL7139_VOUT_OVP_DIS_MASK,
				val);
...
static int hl7139_set_adc_scan(struct hl7139_charger *chg, int channel,
			       bool enable)
{
	u8 mask;
	u8 shift;
...
static int hl7139_irq_init(struct hl7139_charger *chg,
...
static int hl7139_psy_get_property(struct power_supply *psy,
				   ...
				   union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_INPUT_CURRENT_LIMIT:
		...
		if (ret < 0) {
			...
			raw_adc = ((r_data[0] << 4) |
				   (r_data[1] & BITS_ADC_IIN_LSB));
			chg->adc_iin =
				(chg->dev_mode == CP_MODE) ?
					(raw_adc * HL7139_CP_IIN_ADC_STEP) :
					(raw_adc * HL7139_BP_IIN_ADC_STEP);
...
static int hl7139_psy_set_property(struct power_supply *psy,
				   enum power_supply_property psp,
				   const union power_supply_propval *val)
{
	struct hl7139_charger *chg = power_supply_get_drvdata(psy);

	pr_err("[%s]set:[%d],val:[%d]\n", __func__, psp, val->intval);

	switch (psp) {
	case POWER_SUPPLY_PROP_ENERGY_NOW:
		hl7139_enable_charge(chg, val->intval);
		hl7139_check_charge_enabled(chg, &chg->charger_enable);
		pr_info("[%s]%s\n", __func__, chg->charger_enable ? "enable" : "disable");
		break;
	case POWER_SUPPLY_PROP_PRESENT:
...
DEFINE_SIMPLE_ATTRIBUTE(hl7139_dcmode_ops, hl7139_get_devmode,
			hl7139_set_devmode, "0x%02llx\n");
...
static int hl7139_create_debugfs_entries(struct hl7139_charger *chg)
{
	...
	if (!chg->debug_root) {
		...
		#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 5, 0)
		ent = debugfs_create_file_unsafe("address", S_IROTH, chg->debug_root,
					&(chg->debug_address),
					&kutfp_fops_x32_ro);
		#else
		...
		ent = debugfs_create_file("chgmode",
					  S_IFREG | S_IWUSR | S_IRUGO,
					  chg->debug_root, chg,
					  &hl7139_dcmode_ops);
		if (!ent) {
			dev_err(chg->dev,
				"Couldn't create chgmode debug file\n");
			rc = -ENOENT;
		}
	}
	return rc;
...
static enum power_supply_property hl7139_psy_props[] = {
	...
	POWER_SUPPLY_PROP_ENERGY_NOW,//POWER_SUPPLY_PROP_CHARGING_ENABLED
	POWER_SUPPLY_PROP_AUTHENTIC, //POWER_SUPPLY_PROP_SC_BATTERY_PRESENT
	POWER_SUPPLY_PROP_POWER_NOW,//POWER_SUPPLY_PROP_SC_VBUS_PRESENT
	POWER_SUPPLY_PROP_CONSTANT_CHARGE_VOLTAGE,//POWER_SUPPLY_PROP_SC_BATTERY_VOLTAGE
	POWER_SUPPLY_PROP_CONSTANT_CHARGE_CURRENT,//POWER_SUPPLY_PROP_SC_BATTERY_CURRENT
	POWER_SUPPLY_PROP_INPUT_VOLTAGE_LIMIT, //POWER_SUPPLY_PROP_SC_BUS_VOLTAGE
	POWER_SUPPLY_PROP_INPUT_CURRENT_LIMIT, //POWER_SUPPLY_PROP_SC_BUS_CURRENT
	POWER_SUPPLY_PROP_TEMP_AMBIENT,//POWER_SUPPLY_PROP_SC_DIE_TEMPERATURE
	POWER_SUPPLY_PROP_CAPACITY_ERROR_MARGIN,//POWER_SUPPLY_PROP_SC_VBUS_ERROR_STATUS,
	POWER_SUPPLY_PROP_CALIBRATE,//POWER_SUPPLY_PROP_SC_CHARGE_MODE
	POWER_SUPPLY_PROP_SCOPE,//POWER_SUPPLY_PROP_SC_DIRECT_CHARGE
};
...
static int hl7139_psy_register(struct hl7139_charger *chg)
{
	...
	chg->fc2_psy = devm_power_supply_register(chg->dev, &chg->psy_desc,
						  &chg->psy_cfg);
...
{
	struct hl7139_charger *sc =
		container_of(nb, struct hl7139_charger, pm_nb);
				...
				const struct i2c_device_id *id)
{
	...
	if (client->dev.of_node) {
		pdata = devm_kzalloc(&client->dev,
				     sizeof(struct hl7139_platform_data),
				     GFP_KERNEL);
		if (!pdata) {
			dev_err(&client->dev,
				"Failed to allocate pdata memory\n");
			return -ENOMEM;
		}
