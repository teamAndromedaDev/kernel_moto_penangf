...
/*penang code for EKPENAN4GU-1648 by p-lizongrui at 2024/02/26 start*/
static unsigned int last_backlight_level;
/*penang code for EKPENAN4GU-1648 by p-lizongrui at 2024/02/26 end*/
...
/*penang code for EKPENAN4GU-1648 by p-lizongrui at 2024/02/26 start*/
int mtkfb_esd_backlight_recovery(void)
{
	return mtkfb_set_backlight_level(last_backlight_level);
}
...
/*penang code for EKPENAN4GU-1648 by p-lizongrui at 2024/02/26 start*/
	} else if (strncmp(opt, "trigger_esd", 11) == 0) {
		force_recovery += 1;
/*penang code for EKPENAN4GU-1648 by p-lizongrui at 2024/02/26 end*/
