...
{
	int ret = 0;
	pr_info("i2c lm3644 lm3644_pinctrl_set start.\n");
	if (IS_ERR(lm3644_pinctrl)) {
...
static int lm3644_enable_ch1(void)
{
	...
	pr_info("i2c lm3644 lm3644_enable_ch1 start.\n");
...
{
	unsigned char reg, val;
	pr_info("i2c lm3644 lm3644_enable_ch2 start.\n");
	reg = LM3644_REG_ENABLE;
...
{
	unsigned char reg, val;
	pr_info("i2c lm3644 lm3644_disable_ch1 start.\n");
	reg = LM3644_REG_ENABLE;
...
{
	unsigned char reg, val;
	pr_info("i2c lm3644 lm3644_disable_ch2 start.\n");
	reg = LM3644_REG_ENABLE;
...
static int lm3644_set_level_ch1(int level)
{
	int ret;
	unsigned char reg, val;
	pr_info("i2c lm3644 lm3644_set_level_ch1 start.\n");
...
static int lm3644_set_level_ch2(int level)
{
	int ret;
	unsigned char reg, val;
	pr_info("i2c lm3644 lm3644_set_level_ch2 start.\n");
	level = lm3644_verify_level(level);
...
{
	pr_info("i2c lm3644 lm3644_chip_init start.\n");
	if (channel == LM3644_CHANNEL_CH1)
...
int lm3644_init(void)
{
	int ret;
	unsigned char reg, val;
	pr_info("i2c lm3644 lm3644_init start.\n");
	lm3644_pinctrl_set(
...
static int lm3644_ioctl(unsigned int cmd, unsigned long arg)
{
	...
	unsigned int s;
	unsigned int ns;
	pr_info("i2c lm3644 lm3644_ioctl start.\n");
...
static int lm3644_open(void)
{
	...
	pr_info("i2c lm3644 lm3644_open start.\n");
	return 0;
}
...
{
	/* Move to set driver for saving power */
	pr_info("i2clm3644 lm3644_release start.\n");
	/*Penang Code for EKPENAN4GU-4048 by chenxiaoyong at 20240516 start*/
	...
	pr_info("i2clm3644 lm3644_release end.\n");
	/*Penang Code for EKPENAN4GU-4048 by chenxiaoyong at 20240516 end*/
	return 0;
}
...
{
	int ret = 0;
	pr_info("i2c lm3644 lm3644_set_driver start.\n");
...
{
	pr_info("i2c lm3644 lm3644_strobe_store start.\n");
	lm3644_set_driver(1);
		...
		struct lm3644_platform_data *pdata)
{
	...
	u32 decouple = 0;
	int i = 0;
	pr_info("i2clm3644 lm3644_parse_dt start.\n");
		...
		struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	pr_info("i2c lm3644 probe start.\n");
...
/*Penang Code for EKPENAN4GU-4048 by chenxiaoyong at 20240516 start*/
static void lm3644_i2c_shutdown(struct i2c_client *client)
{
	int ret;
	pr_info("lm3644 shutdown start.\n");

	ret = lm3644_write_reg(lm3644_i2c_client, LM3644_REG_ENABLE, LM3644_DISABLE);

	pr_info("lm3644 shutdown done.\n");
}
/*Penang Code for EKPENAN4GU-4048 by chenxiaoyong at 20240516 end*/
