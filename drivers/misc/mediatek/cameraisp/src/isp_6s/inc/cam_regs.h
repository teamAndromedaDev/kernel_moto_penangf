...
#define CAM_REG_LTMSO_FH_BASE_ADDR(module)     (isp_devs[module].regs + 0x461C)
#define CAM_REG_TSFSO_FH_BASE_ADDR(module)     (isp_devs[module].regs + 0x43EC)
#define CAM_REG_LCESHO_FH_BASE_ADDR(module)    (isp_devs[module].regs + 0x46FC)
