...
#if IS_ENABLED(CONFIG_MTK_CHOPDETECTHUB)
#include "chopchop_detector/chopdetecthub.h"
#endif

#if IS_ENABLED(CONFIG_MTK_CAMERAGESTUREHUB)
#include "camera_gesture/camera_gesturehub.h"
#endif

#if IS_ENABLED(CONFIG_MTK_SIGNIFICANT_MOVE)
#include "significant_move/significant_move.h"
#endif
