...
extern void mtk_cam_otp_exit_module(void);
extern int mtk_cam_otp_init_module(void);
...
static inline int adopt_CAMERA_HW_FeatureControl(void *pBuf)
{
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:
	{
		...
		if (buf_size == 8008){//for s5kjn1sq03 Penang Code OTP bringup，modify by wangyaohua 20240304 start
		...
		}//for s5kjn1sq03 Penang Code OTP bringup，modify by wangyaohua 20240304 end
