...
struct IMGSENSOR_HW_POWER_SEQ sensor_power_sequence[] = {
...
#if defined(HI1634Q_MIPI_RAW)
	{
		...
		{
			/*Penang Code for EKPENAN4GP-2058 by chenxiaoyong at 20240810 start*/
			{SensorMCLK, Vol_Low, 3},
			{RST, Vol_Low, 3},
			{DOVDD, Vol_1800, 7},
			{AVDD, Vol_2800, 3},
			{DVDD, Vol_1100, 3}, // dvdd 1.1v
			{SensorMCLK, Vol_High, 3},
			{RST, Vol_High, 7}
			/*Penang Code for EKPENAN4GP-2058 by chenxiaoyong at 20240810 end*/
		},
	},
#endif
